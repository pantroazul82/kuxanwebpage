<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterSoft.Master" AutoEventWireup="true" CodeBehind="frmUsoSoft.aspx.cs" Inherits="mildaWebSite.frm.ley.frmUsoSoft" %>
									...
									<div id="togglePages" class="accordion-body collapse show" aria-labelledby="pages">
										<div class="card-body">
											<ul class="list list-unstyled">
												...
												<li class="mb-2">
													<a data-hash data-hash-offset="100" href="#faq-6" class="font-weight-semibold"><i class="fas fa-angle-right ml-1 mr-1 pr-2"></i> 6. Derechos que MILDA le concede.</a>
												</li>
												<li class="mb-2">
													<a data-hash data-hash-offset="100" href="#faq-7" class="font-weight-semibold"><i class="fas fa-angle-right ml-1 mr-1 pr-2"></i> 7. Derechos que usted concede a MILDA.</a>
												</li>
												<li class="mb-2">
							...
							<div class="row">
								<div class="col">
									...
									<div id="faq-0" class="row mb-5">
										<div class="col">
											<h2 class="font-weight-bold text-4 mb-3">Te damos la bienvenida a MILDA.</h2>
...
<br /><br />•	nunca ha sido condenado o condenada por un delito grave o un delito punible (o algún delito de igual gravedad), o algún delito en el que se haya usado la violencia, usted no está obligado a registrarse como delincuente sexual en ningún registro estatal, federal o local de delincuentes sexuales.
									...
									<div id="faq-6" class="row mb-5">
										<div class="col">
											<h3 class="font-secondary font-weight-bold text-2 mb-3">6. Derechos que MILDA le concede.</h3>
											<p>
...
<br /><br />•	copiar, modificar, transmitir, crear trabajos derivados de, hacer uso de, o reproducir de ninguna manera ningún material o imágenes con derechos de autor, marcas comerciales, nombres comerciales, marcas de servicio, u otra propiedad intelectual, contenidos o información reservada accesible a través del Servicio sin el consentimiento previo por escrito de MILDA.
<br /><br />•	indicar expresa o implícitamente que ninguna de las declaraciones que haga están respaldadas por MILDA.
...
<br /><br />•	“enmarcar” o “reproducir” cualquier parte del Servicio, sin la autorización previa por escrito de MILDA.
<br /><br />•	utilizar metaetiquetas o códigos u otros dispositivos que contengan cualquier referencia a MILDA o al Servicio (o cualquier marca registrada, nombre comercial, marca de servicio, logotipo o eslogan de MILDA) para dirigir a cualquier persona a cualquier otro sitio web para cualquier propósito.
...
<br /><br />•	utilizar, acceder a, o publicar la interfaz de programación de aplicaciones de MILDA sin nuestro consentimiento por escrito.
...
<br /><br />•	fomentar o promover cualquier actividad que viole el presente Acuerdo.
									...
									<div id="faq-7" class="row mb-5">
										<div class="col">
											<h3 class="font-secondary font-weight-bold text-2 mb-3">7. Derechos que usted concede a MILDA.</h3>
											<p>
									...
									<div id="faq-8" class="row mb-5">
										<div class="col">
											<h3 class="font-secondary font-weight-bold text-2 mb-3">8. Reglas para uso con sus amigos.</h3>
											<p>
...
<br /><br />•	utilizar el Servicio con el fin de ocasionar daños a MILDA
