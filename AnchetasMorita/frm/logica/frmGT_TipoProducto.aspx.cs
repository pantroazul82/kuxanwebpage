...
{
    public partial class frmGT_TipoProducto : System.Web.UI.Page
    {
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/frm/logica/frmCrearTPproducto.aspx?cod=" + id);
        ...
        protected void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var user = db.eliminarTipoProducto(int.Parse(id));
