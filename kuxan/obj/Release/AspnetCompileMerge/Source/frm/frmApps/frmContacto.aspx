<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/masterMilda/MildaNoFooter.Master" AutoEventWireup="true" CodeBehind="frmContacto.aspx.cs" Inherits="kuxan.frm.master.masterMilda.frmContacto" %>
    ...
    <section class="section">
					<div class="container">
						<div class="row text-center">
							<div class="col">
								<span class="top-sub-title text-color-primary appear-animation" data-appear-animation="fadeInUpShorter">Milda y Milda LOVE son un producto de Kuxan </span>
									...
									<div class="col-12 col-md-4 col-lg-12 mb-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p>Transversal 93No 51-98 edificio Prana 26, oficina 203</p>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-12 mb-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p><a href="mailto:info@kuxan.co">info@kuxan.co</a></p>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-12 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p> <a href="tel:+5717021552"> (571) 702-15-52</a></p>
											</div>
										</div>
									</div>
								</div>
