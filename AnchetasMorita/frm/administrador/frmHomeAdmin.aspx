<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/master.Master" AutoEventWireup="true" CodeBehind="frmHomeAdmin.aspx.cs" Inherits="kuxan.frm.administrador.frmHomeAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoGeneral" runat="server">
          ...
          <div class="my-account">
            ...
            <div class="dashboard">
              <div class="welcome-msg">
                ...
                <p>Este el modulo de adminsitracion o portal de configuracion del portal Anchetas moritas.</p>
              </div>
              <div class="recent-orders">
                <div class="title-buttons"> <strong>Ordenes Recientes</strong></div>
    ...
    <asp:SqlDataSource ID="SqlPedidos" runat="server" ConnectionString="<%$ ConnectionStrings:AnchetasMoritaConnectionString %>"
         SelectCommand="SELECT top 100 C.ID_COMPRA, C.ID_USUARIO, C.NOMBRES_PRODUCTOS, C.COSTO_TOTAL, C.FECHA_COMPRA, C.FECHA_ENTREGA, C.PAGADA, C.MENSAJE, C.ENTREGAR_A_QUIEN, C.TITULO_MENSAJE, C.DE_PARTE_DE, C.DIRECCION_DE_ENTREGA, TELEFONO_ENTREGA, U.NOMBRE_USUARIO, U.APELLIDOS_USUARIO FROM COMPRAS AS C JOIN USUARIOS AS U ON C.ID_USUARIO = U.ID_USUARIO Order By C.ID_COMPRA desc " ></asp:SqlDataSource>
</asp:Content>
