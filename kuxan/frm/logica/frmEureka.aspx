<%@ Page Title="Eureka" Language="C#" MasterPageFile="~/frm/master/master.Master" AutoEventWireup="true" CodeBehind="frmEureka.aspx.cs" Inherits="kuxan.frm.logica.frmEureka" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="rev_slider_68_1" class="rev_slider fullwidthabanner" data-version="5.0.7" style="display: none;">
            <ul>
                ...
                <li data-description="" data-easein="default" data-easeout="default" data-index="rs-233" data-masterspeed="1500" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-title="Intro" data-transition="fade">
                    <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="5" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="../../img/Eureka1.jpg">
                    <%-- -------- Kuxan-Lab --%>
                    ...
                    <div
                        ...
                        style="z-index: 7; min-width: 721px; max-width: 721px; white-space: normal; text-align: center; color: #000000">
                        EUREKA
                    ...
                    <div
                        ...
                        data-x="['center','center','center','center']"
                        data-y="['middle','middle','middle','middle']"
                        style="z-index: 7; white-space: nowrap; color: #000000">
                           <asp:Label runat="server" ID="Label0" Text="Modernice los procesos de su restaruante o bar, de una"></asp:Label>
                    ...
                    <div
                        ...
                        data-y="['middle','middle','middle','middle']"
                        style="z-index: 7; white-space: nowrap; color: #000000">
                           <asp:Label runat="server" ID="Label1" Text=" manera simple y efectiva"></asp:Label>
    ...
    <div class="page-in">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-in-name">EUREKA</div>
                    <div class="page-in-bread"><a href="../../frm/logica/default.aspx">
                           <asp:Label runat="server" ID="Label2" Text="Inicio"></asp:Label></a> \ EUREKA</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-ms-12_marg50">
                    <div class="presentation-two-img">
                        <img src="../../img/eureka4.jpg" alt=""></div>
                </div>
            </div>
        </div>
        <div class="row">
